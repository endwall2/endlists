...
# Current Version: 1.25  August 30 2017
...
#iptables -I FORWARD "$insert_fwd" -p tcp -d "$int_ip" -s "$whiteout" -m multiport --dports 25,587 -j ACCEPT;
#iptables -I FORWARD "$insert_fwd" -p tcp -s "$int_ip" -d "$whiteout" -m multiport --dports 25,587 -j ACCEPT;
#iptables -I FORWARD "$insert_fwd" -p tcp -d "$int_ip" -s "$whiteout" -m multiport --dports 25,587 -j LOG --log-prefix "["$tag" FORWARD IN] " --log-level=info;
#iptables -I FORWARD "$insert_fwd" -p tcp -s "$int_ip" -d "$whiteout" -m multiport --dports 25,587 -j LOG --log-prefix "["$tag" FORWARD OUT] " --log-level=info;
...
#ip6tables -I FORWARD "$insert6_fwd" -p tcp -d "$int_ipv6" -s "$whiteout" -m multiport --dports "$ports" -j ACCEPT;
#ip6tables -I FORWARD "$insert6_fwd" -p tcp -s "$int_ipv6" -d "$whiteout" -m multiport --dports "$ports" -j ACCEPT;
#ip6tables -I FORWARD "$insert6_fwd" -p tcp -d "$int_ipv6" -s "$whiteout" -m multiport --dports "$ports" -j LOG --log-prefix "["$tag" FORWARD IN] " --log-level=info;
#ip6tables -I FORWARD "$insert6_fwd" -p tcp -s "$int_ipv6" -d "$whiteout" -m multiport --dports "$ports" -j LOG --log-prefix "["$tag" FORWARD OUT] " --log-level=info;
...
iptables -I OUTPUT "$insert_out" -p all -s "$int_ip" -d "$blackout" -j LOG --log-prefix "[ATTACKER OUT] "  --log-level=info && iptables -I INPUT "$insert_in"  -p all -d "$int_ip" -s "$blackout" -j LOG --log-prefix "[ATTACKER IN] "  --log-level=info;
...
#iptables -I FORWARD "$insert_fwd" -p all -d "$int_ip" -s "$blackout" -j LOG --log-prefix "[ATTACKER FORWARD IN] "  --log-level=info;
#iptables -I FORWARD "$insert_fwd" -p all -s "$int_ip" -d "$blackout" -j LOG --log-prefix "[ATTACKER FORWARD OUT] "  --log-level=info;
...
iptables -I OUTPUT "$insert_out" -p all -d "$blackout" -j LOG --log-prefix "[BLACKLIST OUT] " --log-level=info && "iptables" -I INPUT "$insert_in"  -p all -s "$blackout" -j LOG --log-prefix "[BLACKLIST IN] "  --log-level=info;

#iptables -I FORWARD "$insert_fwd" -p all -s "$blackout" -j DROP;
#iptables -I FORWARD "$insert_fwd" -p all -d "$blackout" -j DROP;

#iptables -I FORWARD "$insert_fwd" -p all -s "$blackout" -j LOG --log-prefix "[BLACKLIST FORWARD IN] "  --log-level=info;
#iptables -I FORWARD "$insert_fwd" -p all -d "$blackout" -j LOG --log-prefix "[BLACKLIST FORWARD OUT] "  --log-level=info;
...
ip6tables -I OUTPUT "$insert6_out" -p all -d "$blackout" -j LOG --log-prefix "[IPv6 BLACKLIST OUT] " --log-level=info && ip6tables -I INPUT "$insert6_in" -p all -s "$blackout" -j LOG --log-prefix "[IPv6 BLACKLIST IN] "  --log-level=info ;

#ip6tables -I FORWARD "$insert6_fwd" -p all  -s "$blackout" -j DROP;
#ip6tables -I FORWARD "$insert6_fwd" -p all  -d "$blackout" -j DROP;
#ip6tables -I FORWARD "$insert6_fwd" -p all  -s "$blackout" -j LOG --log-prefix "[IPv6 BLACKLIST FORWARD IN] "  --log-level=info;
#ip6tables -I FORWARD "$insert6_fwd" -p all  -d "$blackout" -j LOG --log-prefix "[IPv6 BLACKLIST FORWARD OUT] "  --log-level=info;
